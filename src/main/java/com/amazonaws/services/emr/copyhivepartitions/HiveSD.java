...
public class HiveSD {
  ...
  //'1', '1', 'org.apache.hadoop.mapred.TextInputFormat', '0', '0', 's3://publicprestodemodata/apachelogsample/hive', '-1', 'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat', '1'
  ...
  public String ToSQLInsert(boolean isFirst){
    ...
    sqlout += "("+NEW_ID+", "+CD_ID+", '"+ INPUT_FORMAT+"' , "+IS_COMPRESSED+", "+ IS_STOREDASSUBDIRECTORIES +", '"+LOCATION+"', "+NUM_BUCKETS+", '"+OUTPUT_FORMAT+"', "+SERDE_ID+")"; 
    return sqlout; 
  }
